...
class MetalensOptimization:
    def __init__(self, data_file='data/data.yaml', *args, **kwargs):
        """
        初始化参数
        """
    ...
    def load_yaml(self):
        ...
        self.sample_interval = parameters.get('sample_interval', 7.25)
        self.N_sampling = parameters.get('N_sampling', 2048)
        self.lambda_list = parameters.get('lambda_list', [8, 9.3, 10.6, 11.3, 12])
